...
int i;   
 ...
 IC ic;
    ...
    public ICG(ArrayList<Tokensets> token) throws IOException {
        this.token=token;
        ...
        i=0;
       this.ic = new IC("./src/compiler/intermediate.txt"); 
    }


boolean SelectionSet() throws IOException{
...
////////////////////////////////////////////////////////////////////////////////////
Boolean DO_While_st() throws IOException 
{
    if(token.get(i).cp.equals("do")){
        this.ic.writer.append(this.ic.CreateLabel());
        i++;
        if(M1())
     if(token.get(i).cp.equals("while")){
         ...
         if(token.get(i).cp.equals("(")){
             i++;
             if(OE())
        this.ic.writer.append("if (T"+this.ic.varCounter+" ==true) jump L"+ic.labelCounter+"\n");
...
Boolean MST() throws IOException 
{
...
Boolean While_st() throws IOException 
{
   String o = null;
    if(token.get(i).cp.equals("while")){
        ...
        i++;
        try {
            ic.writer.append(o=ic.CreateLabel());
        } catch (IOException ex) {
            Logger.getLogger(ICG.class.getName()).log(Level.SEVERE, null, ex);
        }
         if(token.get(i).cp.equals("(")){
             i++;
             if(OE()){
                  ic.writer.append("if (T"+this.ic.varCounter+" ==false) jump "+ic.CreateLabel()+"\n");
                 if(token.get(i).cp.equals(")")){
                     i++;
                     ...
                     if(while_body()){
                         ...
                         ic.writer.append("jump "+(o)
                         +"\n L"+this.ic.labelCounter+":");
...
boolean SST() throws IOException{
...
boolean while_body() throws IOException{
...
boolean Switch_body() throws IOException{
    if(token.get(i).cp.equals("{")){
        i++;
        if(Case()){
            if(Default()){
...
boolean Case() throws IOException{
...
boolean Default() throws IOException{
...
boolean switch_st() throws IOException {
...
boolean for_st() throws IOException {
...
boolean if_sst() throws IOException{
    if(if_st()){return true;}
   else if(While_st()){return true;}
    else if(for_st()){return true;}
    else if(DO_While_st()){return true;}
...
boolean if_mst() throws IOException{
    if(if_sst()){
        if(if_mst()){
            return true;
        }
...
boolean Oelse() throws IOException{
...
boolean if_body() throws IOException{
    if(if_sst()){
        ic.writer.append("jump "+this.ic.CreateLabel());
        return true;
    }
    else if(token.get(i).cp.equals(";")){
        i++;
...
boolean if_st() throws IOException {
    ...
    if(token.get(i).cp.equals("if")){
        ...
        if(token.get(i).cp.equals("(")){
            ...
            if(OE()){
                ...
                if(token.get(i).cp.equals(")")){
                    i++;
       this.ic.writer.append("if (T"+this.ic.varCounter+" ==false) jump "+ic.CreateLabel()+"\n");

                    if(if_body()){
                        if(Oelse()){
                        this.ic.writer.append("L"+this.ic.labelCounter+":");
                         ic.writer.flush();
                         ic.writer.close();
...
boolean func_body() throws IOException {
...
boolean return_type() throws IOException {
...
boolean CS1() throws IOException{
...
boolean func_st() throws IOException{
if(token.get(i).cp.equals("Accessmodifier")||token.get(i).cp.equals("static")||token.get(i).cp.equals("final")||token.get(i).cp.equals("abstract")||token.get(i).cp.equals("void")||token.get(i).cp.equals("String")||token.get(i).cp.equals("ID")||token.get(i).cp.equals("DT")){
  ...
  boolean  Cons_body() throws IOException{
        if(token.get(i).cp.equals("{")){
             i++;
             if(if_mst()){
                     if(token.get(i).cp.equals("}")){
...
if(C3()){
  ...
  boolean class_mst() throws IOException{
if(token.get(i).cp.equals("Accessmodifier")||token.get(i).cp.equals("static")||token.get(i).cp.equals("final")||token.get(i).cp.equals("abstract")||token.get(i).cp.equals("void")||token.get(i).cp.equals("DT")||token.get(i).cp.equals("ID")||token.get(i).cp.equals("string")){
  ...
  boolean class_body() throws IOException{
...
boolean Class_St() throws IOException{
